...
module.exports = {
  ...
  getAllDrivers: getAll('drivers', true),
  getDriverById: getById('drivers'),
  getAllOfficials: getAll('officials', true),
  getOfficialById: getById('officials'),
  getAllVehicles: getAll('vehicles', true),
  getVehicleById: getById('vehicles'),
  getAllFuelRivs: getAll('fuel_rivs'),
  getFuelRivById: getById('fuel_rivs'),
  getAllFuelRivItems: getAll('fuel_riv_items'),
  getAllTripTickets: getAll('trip_tickets'),
  getTripTicketById: getById('trip_tickets'),
  getAllTripLogs: getAll('trip_logs'),
  getTripLogById: getById('trip_logs'),
};
